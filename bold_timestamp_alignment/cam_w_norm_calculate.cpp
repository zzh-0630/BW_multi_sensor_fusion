...
int main() {
    ...
    std::string folder = "/home/fusion/data/cam0/";
    std::string csv_path = "/home/fusion/data/cam0_timestamp.csv";
    std::string save_path = "/home/fusion/fusion_data/visual_angular_velocity_mid_cpp.csv";
